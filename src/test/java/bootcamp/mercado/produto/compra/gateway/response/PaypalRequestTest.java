...
import bootcamp.mercado.produto.compra.CompraRequestBuilder;
...
class PaypalRequestTest {
    ...
    @BeforeEach
    public void setup() {
        Mockito.when(gateway.getNome()).thenReturn("Paypal");
        ...
        compraBuilder.setGateway("Paypal");
    ...
    public void testaPagamentoSucessoValido() {
        ...
        PaypalStatus status = PaypalStatus.SUCESSO;

        PaypalRequest request = new PaypalRequest(compra.getId(), id, status);
        Set<ConstraintViolation<PaypalRequest>> errors = validator.validate(request);
    ...
    public void testaPagamentoErroValido() {
        Compra compra = pickRandomValue(compras);
        String id = "ID Qualquer";
        PaypalStatus status = PaypalStatus.ERRO;
    ...
    public void testaCompraIDVazioInvalido(Long compra) {
        ...
        PaypalRequest request = new PaypalRequest(compra, id, status);
        Set<ConstraintViolation<PaypalRequest>> errors = validator.validate(request);
    ...
    public void testaCompraFinalizadaInvalido() {
        ...
        id = "Um ID Diferente";
        request = new PaypalRequest(compra.getId(), id, status);
    ...
    public void testaPagamentoIDDuplicadoInvalido(String id) {
        ...
        PaypalRequest duplicada = new PaypalRequest(compra.getId(), id.toLowerCase(), status);
    ...
    @ParameterizedTest
    @NullSource
    public void testaStatusVazioInvalido(PaypalStatus status) {
        Compra compra = pickRandomValue(compras);
